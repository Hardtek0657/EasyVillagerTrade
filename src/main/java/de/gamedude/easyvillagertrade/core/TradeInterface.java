...
public class TradeInterface {
    ...
    public void selectTrade() {
        ...
        minecraftClient
            .getNetworkHandler()
            .sendPacket(new SelectMerchantTradeC2SPacket(tradeSlotID));
    ...
    public void pickupBook() {
        ...
        if (0 <= freeSlot && freeSlot <= 8) freeSlot += 30;
        else if (freeSlot != -999) freeSlot -= 6;
        else player.sendMessage(Text.translatable("evt.logic.book_drop"));
